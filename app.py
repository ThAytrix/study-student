...
client = pymongo.MongoClient("mongodb://aw-groupe:ZLdKC3uaEBfC8Ec2h1SsqVHFGTNK4Fm0vDGwseGyipcnzt5ijjoFmKRKse6ahJusTsKKJ8Fu2d4HD2YN0NmyLw==@aw-groupe.mongo.cosmos.azure.com:10255/?ssl=true&replicaSet=globaldb&retrywrites=false&maxIdleTimeMS=120000&appName=@aw-groupe@")
mydb = client["study-student"]
...
def saveStudentDate(formData):
    studentData = {
        "prenom": formData['prenom'],
        "sex": formData['sex'],
        "age": formData['age'],
        "famsize": formData['famsize'],
    ...
    mycol2 = mydb["student_test"]
    mycol2.insert(studentData)
